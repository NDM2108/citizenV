...
export default function Analysis(props) {
  ...
  var tilenam = Math.round(
    (percent_male * 100) / (percent_male + percent_female)
  );
  var tilenu = Math.round(
    (percent_female * 100) / (percent_male + percent_female)
  );
  ...
  var tileu18 = Math.round(
    (percent_teenager * 100) / (percent_teenager + percent_older)
  );
  var tileok = Math.round(
    (percent_older * 100) / (percent_teenager + percent_older)
  );
    ...
    <div style={{ marginTop: "10px" }}>
      ...
      <div className="Chart_phan_tich" id="chu_thich1">
        ...
        <ul className="legend_phan_tich">
          <li>
            <span className="legend_1"></span> Nam
          </li>
          <li>
            <span className="legend_2"></span> Nữ
          </li>
        </ul>
      </div>
      ...
      <div className="Chart_phan_tich_2" id="chu_thich2">
        ...
        <ul className="legend_phan_tich">
          <li>
            <span className="legend_3"></span> Dưới 18 tuổi
          </li>
          <li>
            <span className="legend_4"></span> Trên 18 tuổi
          </li>
        </ul>
      </div>
