...
//             const newSelecteds = rows.map((n) => n.tinh);
...
//     const handleClick = (event, tinh) => {
//         const selectedIndex = selected.indexOf(tinh);
//         let newSelected = [];

//         if (selectedIndex === -1) {
//             newSelected = newSelected.concat(selected, tinh);
...
//                                 .map((row, index) => {
//                                     const isItemSelected = isSelected(row.tinh);
//                                     const labelId = `enhanced-table-checkbox-${index}`;

//                                     return (
//                                         <TableRow
//                                             hover
//                                             onClick={(event) => handleClick(event, row.tinh)}
//                                             role="checkbox"
...
//                                                 {row.tinh}
//                                             </TableCell>
//                                             <TableCell align="right">{row.sodan}</TableCell>
//                                             <TableCell align="right">{row.soho}</TableCell>
//                                             {/* <TableCell align="right">{row.carbs}</TableCell> */}
//                                             <TableCell align="right">{row.tiendo}</TableCell>
//                                         </TableRow>
//                                     );
//                                 })}
//                             {emptyRows > 0 && (
